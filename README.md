...
Slice Enterprise hosts running events around Seattle with a food theme. Some of these events
include:

- **Slice-a-Thon**: Half Marathon run making stops at local pizza joints
- **Taco Ocho**: 8 miles, 8 Tacos, all on August 8th
- **Eggnog Leg Jog**: Kicking off the holiday season with some baked goods and dancing around Green
  Lake

The webapp provides a landing page for all information regarding the organization and races being
hosted by Slice Enterprise.

## Requirements

- **Bun** (v1+): This project uses **Bun** as the package manager. Use `bun` for install, scripts,
  and running — not npm or yarn.
...
Follow the setup instructions on Vercel's
...
[seattlesliceenterprise@gmail.com](mailto:seattlesliceenterprise@gmail.com)
